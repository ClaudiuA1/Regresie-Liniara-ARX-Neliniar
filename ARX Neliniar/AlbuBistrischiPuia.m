...
Grad_m=(1:na)';
tp=table(Grad_m,array2table(EMP_Predictie,'VariableNames',{'1','2','3','4'}),'VariableNames',{'Grad M','Ordin Na si Nb'});
fprintf("Erorile la predictie\n")
disp(tp)

ts=table(Grad_m,array2table(EMP_Similare,'VariableNames',{'1','2','3','4'}),'VariableNames',{'Grad M','Ordin Na si Nb'});
fprintf("Erorile la simulare la validare\n")
disp(ts)

tsi=table(Grad_m,array2table(EMP_Similare_id,'VariableNames',{'1','2','3','4'}),'VariableNames',{'Grad M','Ordin Na si Nb'});
